...
class Magpleasure_Massshipping_Block_Adminhtml_Import_Excel extends Magpleasure_Massshipping_Block_Adminhtml_Import_Abstract
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate("massshipping/import/excel.phtml");
    }
    ...
    public function getImportButtonHtml()
    {
        return $this->_getButtonHtml(array(
            ...
            'onclick' => "{$this->_helper()->getJsObjectName()}.postExcelForm('grid', this);",
