...
class Magpleasure_Info_Model_Feed extends Mage_Core_Model_Abstract
{
    ...
    protected function _getProducFromFeed($name)
    {
        $this->getFeed();
    ...
    {
        return $this->_getProducFromFeed($name)->getProductName();
    }

    public function getAvailableVersion($name)
    {
        return $this->_getProducFromFeed($name)->getVersion();
    }

    public function getProductUrl($name)
    {
        return $this->_getProducFromFeed($name)->getProductUrl();
    }
