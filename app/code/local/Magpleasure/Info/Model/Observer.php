...
class Magpleasure_Info_Model_Observer
{
    ...
    {
        # Check Extensions
        if ((time() - Mage::app()->loadCache('mp_info_check')) > Mage::getStoreConfig('mpinfo/check/timeout')) {
        ...
        # Get Feed Url
        if ((time() - Mage::app()->loadCache('mp_info_feed_url')) > Mage::getStoreConfig('mpinfo/url/timeout')) {
        ...
        # Get Feed
        if ((time() - Mage::app()->loadCache('mp_info_feed')) > Mage::getStoreConfig('mpinfo/feed/timeout')) {
